...
describe("ScheduledRunManager create/list/status/cancel", () => {
	...
	function freshHarness(options: { config?: ExtensionConfig; now?: number; resolveCapabilityCeiling?: (sessionId: string) => { version: 1; allowedTools?: string[]; denyExtensions: boolean; sources: string[] } | undefined } = {}): TestHarness {
