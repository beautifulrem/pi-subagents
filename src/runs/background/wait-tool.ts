...
• { id: "..." } — wait for one async or remembered detached foreground subagent run (id or prefix); if a current-session async target already finished, return its persisted terminal state immediately.
